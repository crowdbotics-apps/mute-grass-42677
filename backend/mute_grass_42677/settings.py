"""
Django settings for mute_grass_42677 project.
...
ROOT_URLCONF = 'mute_grass_42677.urls'
...
WSGI_APPLICATION = 'mute_grass_42677.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_grass_42677 API",
    "DESCRIPTION": "API documentation for mute_grass_42677 App",
    "VERSION": "v1",
}
